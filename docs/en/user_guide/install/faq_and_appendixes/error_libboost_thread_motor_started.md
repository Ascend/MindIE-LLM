# `libboost_thread.so.1.82.0` Cannot Be Found When MindIE Motor CPP Is Started

## Symptom

When MindIE Motor CPP is started, an error message is displayed, indicating that `libboost_thread.so.1.82.0` cannot be found, as shown in the following figure.
