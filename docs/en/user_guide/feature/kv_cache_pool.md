...
3. Start the centralized master service corresponding to the pooling backend. For details about the installation and startup commands, see [KV Cache Pooling Usage Guide](https://gitcode.com/Ascend/MindIE-LLM/blob/v3.1.0/docs/en/user_guide/feature/mempool.md).
