...
5. Send an inference request. For details, see "Cluster Management Components" \> "Coordinator" \> "RESTful APIs" \> "User-Side APIs" \> "OpenAI Inference APIs" in *[MindIE Motor Development Guide](https://www.hiascend.com/document/detail/en/mindie/310/mindiellm/llmdev/mindie_llm0022.html)*.
