...
1. Install [msModelSlim](https://gitcode.com/Ascend/msmodelslim/blob/26.1.0/docs/en/install_guide/install_guide.md).
2. Complete the required checks before running DeepSeek-V3/R1. For details, see the [msModelSlim quantization description](https://gitcode.com/Ascend/msmodelslim/blob/26.1.0/example/DeepSeek/README.md).
