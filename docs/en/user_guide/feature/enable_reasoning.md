...
4. Send a request. For parameter details, see "OpenAI-Compatible Interfaces" > " [Inference APIs](https://www.hiascend.com/document/detail/en/mindie/310/mindiellm/llmdev/mindie_llm0022.html)".
