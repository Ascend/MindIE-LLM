...
> [!NOTE]说明
> 上方以mindie_llm包为例，如升级MindIE Motor CPP或MindIE SD，请替换为对应的whl包名。
...
7. 软件包升级完成后，请参考以下方式更新依赖，两种方式任选其一。
    ...
    - 方式二：参考[安装依赖](./installing_software_and_dependencies.md#安装依赖)章节，使用以下命令安装当前版本所需的全量依赖。（该方式可能会将环境中已指定的依赖版本覆盖）
