...
|file:line|文件名:代码行号。|
|error code|Critical级别和部分Error级别日志的错误码，错误码请参见《[MindIE错误码参考](https://www.hiascend.com/document/detail/zh/mindie/310/ref/errorcodereference/mindie_log_0072.html)》。|
|**log message**|具体错误信息。|
