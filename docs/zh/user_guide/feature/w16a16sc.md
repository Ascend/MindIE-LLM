...
1. 使用以下指令生成W16A16S浮点稀疏权重。
    ...
    - 该量化方式目前已经集成到msModelSlim工具的一键量化功能中，参数配置及详细说明可参考《msModelSlim工具》的“[一键量化使用说明](https://gitcode.com/Ascend/msmodelslim/blob/master/docs/zh/user_guide/usage_quick_quantization.md
    )”章节。
